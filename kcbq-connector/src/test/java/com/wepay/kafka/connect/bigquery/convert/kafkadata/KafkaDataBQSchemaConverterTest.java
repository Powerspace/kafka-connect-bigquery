...
public class KafkaDataBQSchemaConverterTest {
  ...
  public void test() {
    ...
    com.google.cloud.bigquery.Schema bigQueryExpectedSchema =
        com.google.cloud.bigquery.Schema.of(kafkaDataField, baseField);
  ...
  private Field getKafkaDataField() {
    ...
    return Field.newBuilder("kafkaData", LegacySQLTypeName.RECORD, topicField, partitionField,
            offsetField, insertTimeField)
            .setMode(Field.Mode.NULLABLE)
            .build();
  }
}
